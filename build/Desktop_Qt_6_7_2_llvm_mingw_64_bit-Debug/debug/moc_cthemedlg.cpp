...
constexpr auto qt_meta_stringdata_CLASSCThemeDlgENDCLASS = QtMocHelpers::stringData(
    "CThemeDlg",
    "themeToGame",
    "",
...
void CThemeDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &CThemeDlg::themeToGame; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &CThemeDlg::game_theme_background_change; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (CThemeDlg::*)(QString );
            if (_t _q_method = &CThemeDlg::game_theme_gem_change; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
